...
ru = Locale(
    ...
    chat_placeholder="Начните беседу с исскусственным интеллектом:",
    ...
    radio_text1="Выбрать",
    radio_text2="Создать",
    stt_placeholder="Чтобы услышать голос ЦАР-ассистента, нажми кнопку проигрывателя",
    footer_title="Поддержка и обратная связь",
    footer_option0="Чат",
    footer_option1="Общая информация",
    #footer_option2="Донаты",
    footer_chat="Приложение для общения с ЦАР-ассистентом",
    footer_channel="ЦАР, МТБанк",
    responsibility_denial="""
        Командой ЦАР был разработан прототип ЦАР-ассистента - помощника на основе искусственного интеллекта. 
