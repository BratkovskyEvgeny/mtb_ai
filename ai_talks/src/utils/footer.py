...
#st.text("Командой ЦАР был разработан прототип ЦАР-ассистента - помощника на основе искусственного интеллекта. 
        #ЦАР-ассистент успешно справляется с задачами, связанными с генерацией программного кода, код-ревью. В настоящее время
